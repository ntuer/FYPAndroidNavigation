...
public class MainActivity extends Activity {
    ...
    private void  init_Button()
    {
        ...
        Get_Lanlng.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Intent intent = new Intent(MainActivity.this, InitBeaconPositionActivity.class);//go to InitBeaconPositionActivity
        ...
        Demo.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                Intent intent = new Intent(MainActivity.this, DemoActivity.class);//go to DemoActivity
                startActivity(intent);
            }
        });
