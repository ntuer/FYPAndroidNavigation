...
public class InitBeaconPositionActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initButton();//initialize all buttons and their event listeners
        initMap();
    ...
    private void initButton(){
        ...
        BT_Pluse.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                changeImage();//update the image of the floor
            }
        });
        ...
        BT_DELETE.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {//remove the marker on the view and beacon from the database
                if (marker != null) {
        ...
        BT_Calibreate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (marker != null && curr_or_max == false) {//current is selected
                    ...
                    Beacon sensor = GlobalData.beaconlist.get(marker.getTitle());
                    sensor.max_rssi = sensor.rssi;//update the sensor's max rssi to be the sensor's current rssi
                    ...
                    Beacon max_sensor = Tools.getMaxRssiSensor(GlobalData.templist);//get the beacon with max rssi
                    if (max_sensor == null
                            ||(max_sensor!=null
                    ...
                    sensor.ID =  max_sensor.major + max_sensor.minor;//assign all values of the max beacon to the current marked beacon
    ...
    private void initMap(){
       ...
       // map.setMapType(GoogleMap.MAP_TYPE_SATELLITE);
        ...
        map.setOnMapLongClickListener(new GoogleMap.OnMapLongClickListener() {
            @Override
            public void onMapLongClick(LatLng latLng) {//long click to add marker
        ...
        map.setOnMarkerDragListener(new GoogleMap.OnMarkerDragListener() {
            ...
            @Override
            public void onMarkerDragEnd(Marker marker) {//after the marker is dragged, show some snippets
        ...
        image  =  map.addGroundOverlay( new GroundOverlayOptions()      //draw the building map over the google map
...
/*            edge.polyline = map.addPolyline(new PolylineOptions()
    ...
    private void changeImage(){//reload a different map
